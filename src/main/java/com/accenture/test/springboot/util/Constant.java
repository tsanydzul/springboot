...
public class Constant {
    ...
    public static String MESSAGE_SYSTEM_ERROR = "System error, we're unable to process your request at the moment";
    public static Integer CODE_DATA_NOT_FOUND = 30000;
    public static Integer CODE_NON_UNIQUE = 30001;
    public static Integer CODE_INVALID_FIELD_OR_VALUE = 30002;
    public static String MESSAGE_DATA_ALREADY_EXIST = "Record with unique value :value already exists in the system";
}
